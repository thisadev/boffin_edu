      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/courses/category/dasaca-certification" className="text-gray-400 hover:text-white transition-colors">
                  DASACA&trade; Certification
                </Link>
              </li>
              <li>
                <Link href="/courses/category/data-analytics-boot-camp" className="text-gray-400 hover:text-white transition-colors">
                  Data Analytics Boot Camp
                </Link>
              </li>
              <li>
                <Link href="/courses/category/corporate-training" className="text-gray-400 hover:text-white transition-colors">
                  Corporate Training
                </Link>
              </li>
            </ul>
