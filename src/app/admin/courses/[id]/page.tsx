...
export default function CourseForm({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = isNewCourse ? "/api/admin/courses" : `/api/admin/courses/${params.id}`;
        ...
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            ...
            <button
              ...
              className={`${activeTab === "pricing" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
            >
              Pricing
            </button>
            <button
              onClick={() => setActiveTab("modules")}
              className={`${activeTab === "modules" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}
            >
              Modules & Content
            </button>
          </nav>
