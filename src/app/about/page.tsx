        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Practicality</h3>
              <p className="text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-primary font-medium mb-4">Chief Academic Officer</p>
                <p className="text-gray-700 mb-4">
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="bg-gray-100 rounded-lg p-8 md:p-12">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Start Your Data Analytics Journey?</h2>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <Link href="/courses" className="bg-primary text-white px-6 py-3 rounded-lg font-bold hover:bg-primary/90 transition-colors">
                  Explore Courses
                </Link>
                <Link href="/contact" className="bg-white text-primary border border-primary px-6 py-3 rounded-lg font-bold hover:bg-gray-50 transition-colors">
                  Contact Us
                </Link>
              </div>
            </div>
